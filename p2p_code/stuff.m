...
for ii=1:5
    ...
    p2p_c.plotretgrid(trl(ii).maxphos(:, :, 1)*64./v.drawthr, v, gray(64), 6,[ 'subplot(2,3,', num2str(ii), '); title(''phosphene'')';]);
    p2p_c.draw_ellipse(trl(ii), 6,['subplot(2,3,', num2str(ii), ')'], 1)
