...
for ii=1:5
    ...
    [tmp, v.e(ii).ecc] = cart2pol(median([d(ii).polycenterx.val]), median([d(ii).polycentery.val]));
    v.e(ii).ang = tmp*180/pi;
    % set up v and c for each electrode
    switch ii
        case 1
            %v.e(1).ang = 19.8;      v.e(1).ecc = 26.6;  
            c.e(1).radius = 1.150 ; % in cm
            v.retinaSize = [30,30]; v.pixperdeg = 5;
            v.retinaCenter = [25,10];
        case 2
           % v.e(2).ang = -166.4;    v.e(2).ecc = 9;    
            c.e(2).radius = 1.15/2;
            v.retinaSize = [20,20];v.pixperdeg = 8;
            v.retinaCenter = [-10,0];
        case 3
            %v.e(3).ang = 142.2;     v.e(3).ecc = 5.12; 
            c.e(3).radius = 1.150 ;
            v.retinaSize = [8,8];v.pixperdeg = 8;
            v.retinaCenter = [-4,3];
        case 4 % central electrodes
            %v.e(4).ang = 135;       v.e(4).ecc = 1.9;  
            c.e(4).radius = 1.150 ;
            v.retinaSize = [6,6];v.pixperdeg = 10;
            v.retinaCenter = [-1.25,1];   
        case 5
            %v.e(5).ang = 146.3;     v.e(5).ecc = 1;     
            c.e(5).radius = 1.150 ;
